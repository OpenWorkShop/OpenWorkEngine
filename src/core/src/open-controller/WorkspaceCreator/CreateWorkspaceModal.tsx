...
import {ICustomizedMachine, normalizeAxisName} from '../Machines';
import {slugify} from '../../utils';
import {PortStatus, useSystemPorts} from '../Ports';
  ...
  async function onPressCreate() {
    ...
    const workspaceSettings: WorkspaceSettingsInput = {
      ...
      commands: machine.commands.map((cmd) => {
        return { ..._.omit(cmd, ['__typename']), syntax: ProgramSyntax.GCode };
      }),
      connection: {
        portName,
        machineProfileId: machine.profile.machineProfileId ?? null,
