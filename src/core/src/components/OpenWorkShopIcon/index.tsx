...
export type IconName = 'adjustments-alt' | 'adjustments' | 'bell' | 'blueprint' | 'calipers' | 'certificate' | 'checklist' | 'circular-saw-blade' | 'cnc' | 'compass-circle' | 'console' | 'control-pad' | 'cube-in-glass' | 'cutters' | 'drill' | 'end-mill' | 'extruder' | 'flashlight' | 'game-pad-alt' | 'game-pad' | 'gear-alt' | 'gear' | 'hammer-and-screwdriver' | 'hammer-x-saw' | 'heated-bed' | 'joystick' | 'ladder' | 'laser' | 'machine' | 'magnet' | 'makermade' | 'maslow' | 'microchip' | 'microphone' | 'microscope' | 'move-center' | 'move-down-left' | 'move-down-right' | 'move-down' | 'move-in' | 'move-left' | 'move-out' | 'move-right' | 'move-up-left' | 'move-up-right' | 'move-up' | 'move-zero' | 'paint-brush' | 'paint-roller' | 'pencil-x-ruler' | 'roadblock' | 'robot' | 'ruler-imperial' | 'ruler-metric' | 'rulers' | 'saw' | 'screwdriver-and-wrench' | 'screwdriver-x-wrench' | 'shovel' | 'tape-measure' | 'tdp' | '3dp' | 'telescope' | 'terminal' | 'toolbox' | 'tree' | 'trees' | 'video-camera' | 'view-3d' | 'view-front' | 'view-inside' | 'view-layers' | 'view-left' | 'view-perspective' | 'view-plane' | 'view-right' | 'view-top' | 'view-unknown' | 'wood-cutter' | 'xyz';
export type ComponentName = 'AdjustmentsAltIcon' | 'AdjustmentsIcon' | 'BellIcon' | 'BlueprintIcon' | 'CalipersIcon' | 'CertificateIcon' | 'ChecklistIcon' | 'CircularSawBladeIcon' | 'CncIcon' | 'CompassCircleIcon' | 'ConsoleIcon' | 'ControlPadIcon' | 'CubeInGlassIcon' | 'CuttersIcon' | 'DrillIcon' | 'EndMillIcon' | 'ExtruderIcon' | 'FlashlightIcon' | 'GamePadAltIcon' | 'GamePadIcon' | 'GearAltIcon' | 'GearIcon' | 'HammerAndScrewdriverIcon' | 'HammerXSawIcon' | 'HeatedBedIcon' | 'JoystickIcon' | 'LadderIcon' | 'LaserIcon' | 'MachineIcon' | 'MagnetIcon' | 'MakermadeIcon' | 'MaslowIcon' | 'MicrochipIcon' | 'MicrophoneIcon' | 'MicroscopeIcon' | 'MoveCenterIcon' | 'MoveDownLeftIcon' | 'MoveDownRightIcon' | 'MoveDownIcon' | 'MoveInIcon' | 'MoveLeftIcon' | 'MoveOutIcon' | 'MoveRightIcon' | 'MoveUpLeftIcon' | 'MoveUpRightIcon' | 'MoveUpIcon' | 'MoveZeroIcon' | 'PaintBrushIcon' | 'PaintRollerIcon' | 'PencilXRulerIcon' | 'RoadblockIcon' | 'RobotIcon' | 'RulerImperialIcon' | 'RulerMetricIcon' | 'RulersIcon' | 'SawIcon' | 'ScrewdriverAndWrenchIcon' | 'ScrewdriverXWrenchIcon' | 'ShovelIcon' | 'TapeMeasureIcon' | 'TdpIcon' | 'TelescopeIcon' | 'TerminalIcon' | 'ToolboxIcon' | 'TreeIcon' | 'TreesIcon' | 'VideoCameraIcon' | 'View3dIcon' | 'ViewFrontIcon' | 'ViewInsideIcon' | 'ViewLayersIcon' | 'ViewLeftIcon' | 'ViewPerspectiveIcon' | 'ViewPlaneIcon' | 'ViewRightIcon' | 'ViewTopIcon' | 'ViewUnknownIcon' | 'WoodCutterIcon' | 'XyzIcon';
