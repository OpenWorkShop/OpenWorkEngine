...
const CustomizeMachine = (props) => {
    ...
    React.useEffect(() => {
        var _a;
        if (loadedMachineProfile && (!customizedMachine || customizedMachine.profile.machineProfileId !== loadedMachineProfile.id)) {
    ...
    function onCreatingMachineProfile(firmware, profile) {
        ...
        const defaultAxis = { id: '', name: AxisName.X, min: 0, max: 500, accuracy: 0.01, precision: 2 };
        setCustomizedMachine({
            firmware: firmware,
            profile: profile,
            name: profile.model,
    ...
    function onCompletedParts(parts) {
        ...
        const cm = Object.assign(Object.assign({}, customizedMachine), { parts: _.cloneDeep(parts) });
    ...
    function onChangedAxes(axes) {
        ...
        const cm = Object.assign(Object.assign({}, customizedMachine), { axes: _.cloneDeep(axes) });
        setCustomizedMachine(cm);
        props.onCustomized(cm);
    }
    function startOver() {
    ...
    return (React.createElement(Grid, { container: true, spacing: 2, style: { marginBottom: theme.spacing(2) } },
        React.createElement(Grid, { item: true, xs: 12 },
            ...
            React.createElement("div", { style: { marginTop: theme.spacing(1) } },
                ...
                !customizedMachine && searchMachines && (React.createElement("div", null,
                    React.createElement("em", null,
                        React.createElement(Trans, null, "Most CNC and 3D printing machines are supported, even if they are not in the community catalog..."))))),
